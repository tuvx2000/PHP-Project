                    ...
                    <table class="tbl-30">
                         <tr>
                              ...
                              <td>
                                   ...
                                   placeholder="Title of the Food" value="<?php echo $title;?>">
                              </td>
                         </tr>
                         <tr>
                              <td>Description: </td>
                              ...
                              <td>
                                   <?php
                                        ...
                                        else
                                        {
                                             ...
                                             <?php echo $current_image;?>" width="150px">
                                             <?php
                                        }
                                   ?>
                              </td>
                              ...
                              if($image_name!= "")
                              {
                                   ...
                                   if($current_image!="")
                                   {
                                        ...
                                        if($remove==false)
                                        {
                                             ...
                                             "<div class='error'>failded to connect </div>";
                                             header('location'.SITEURL.'admin/manage-product.php');
                                             die();
                                        }
                                   }
